...
const ProductDetails: FunctionComponent<ProductInterface> = ({
  ...
  return (
    <div className="bp-product-detail">
      <div className="bp-container col-container mb20">
        <div className={`col-6 col-xs-12 bp-product-detail_image`}>
          <figure>
            <picture>
              <source
        ...
        <div className="col-6 col-xs-12">
          ...
          <div className="col-container bp-product-detail_socialWrapper">
            ...
            {product._rawIngredients && (
              <div className="bp-product-detail_accordion">
                <button
                  type="button"
                  className="bp-product-detail_accordion_header"
                ...
                >
                  ...
                  <ArrowUp
                    className={
                      accordion
                        ? 'bp-product-detail_accordion_header_up'
                        : 'bp-product-detail_accordion_header_down'
                    }
                  />
                </button>
                <div
                  className={
                    accordion
                      ? 'bp-product-detail_accordion_contentExpand'
                      : `bp-product-detail_accordion_contentCollapse`
                  }
                >
                  <BlockContent
